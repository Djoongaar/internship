...
#define CONFIGURE_ARGS " '--build=' '--enable-nls=ru' '--disable-rpath' '--with-pgport=5432' '--prefix=/home/evgeny/Projects/internship/.local' '--with-python' '--with-openssl' 'build_alias='"
...
#define PG_VERSION_STR "PostgreSQL 15.7 on x86_64-pc-linux-gnu, compiled by gcc (Debian 12.2.0-14) 12.2.0, 64-bit"
